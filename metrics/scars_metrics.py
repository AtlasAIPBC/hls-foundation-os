...
generated_path = "/home/ada/prithvi/datasets/test/burn_scars/output/"
mask_path = "/home/ada/prithvi/datasets/burn_scars/validation/"
...
def calculate_accuracy(gt_mask, pred_mask):
    ...
    # print(correctly_classified_pixels, total_pixels)
    # Calculate accuracy
...
print("Mean Burn Scars IoU:", round(np.mean(flood_ious), 3))
print("Mean Not Burned IoU:", round(np.mean(non_flood_iou), 3))
